...
import { CHART_COLORS, AXIS_TICK_STYLE, GRID_PROPS, BAR_HOVER_PROPS, TOOLTIP_CURSOR_FILL, classifyOutcome } from '../chartTheme';
                    ...
                    content={
                        <CustomTooltip
                            ...
                            footer={(payload) => {
                                ...
                                return `Based on ${row.total.toLocaleString()} case${row.total === 1 ? '' : 's'}`;
                            }}
                        />
                    }
                />
