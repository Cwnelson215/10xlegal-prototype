...
const mockCases = [
    {
        ...
        lawyerId: '',
        court: 'Salt Lake',
        prosecutionAttorneys: [{ id: 'att-1', name: 'Test Prosecutor' }],
        defenseAttorneys: [{ id: 'att-2', name: 'Test Defender' }],
    ...
    },
    {
        ...
        lawyerId: '',
        court: 'Utah',
        prosecutionAttorneys: [{ id: 'att-3', name: 'Another Prosecutor' }],
        defenseAttorneys: [{ id: 'att-4', name: 'Another Defender' }],
        prosecutionFirm: 'Test Prosecution Firm',
        prosecutionFirmId: 'firm-1',
        ...
        convictionOutcome: 'Guilty',
        convictionDate: '2026-05-12',
        ruling: 'Guilty',
        sentence: '30 days',
        caseType: 'Criminal',
        offenseCode: '',
